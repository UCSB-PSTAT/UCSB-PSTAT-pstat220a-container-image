                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            ...
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME R -e "library(\"tidyverse\");library(\"car\");library(\"lindia\");library(\"patchwork\");library(\"rlm\");library(\"quantreg\");library(\"qvalue\");library(\"GGally\")"'
